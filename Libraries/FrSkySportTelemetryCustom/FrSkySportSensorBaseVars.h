...
#define BASEVARS_XACC_DATA_ID3 0x0700			// Raw IMU ACC
#define BASEVARS_YACC_DATA_ID4 0x0710
#define BASEVARS_ZACC_DATA_ID5 0x0720
#define BASEVARS_XGYRO_DATA_ID6 0x0701			// Raw IMU Gyro
#define BASEVARS_YGYRO_DATA_ID7 0x0711
#define BASEVARS_ZGYRO_DATA_ID8 0x0721
#define BASEVARS_XMAG_DATA_ID9 0x0702			// Raw IMU Mag
#define BASEVARS_YMAG_DATA_ID10 0x0712
#define BASEVARS_ZMAG_DATA_ID11 0x0722
